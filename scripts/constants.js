const initialCards = [
  {
    ...
    alt: 'Эйфелева башня на фоне заката'
  },
  {
    name: 'Венеция',
    ...
    alt: 'Лодки, плывущие по улице Венеции'
  },
  {
    name: 'Египет',
  ...
  },
  {
    ...
    alt: 'Трамвай едет по узкой улочке Лиссабона'
  },
  {
    name: 'Тайланд',
    ...
    alt: 'Зона отдыха возле бассейна'
  }
];
